...
export const DEFAULT_HOTEL_IMAGE = 'https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&w=1200&q=75'

/** รูปภาพเริ่มต้นสำหรับรถ (ถ้าไม่มีรูป) */
export const DEFAULT_CAR_IMAGE = 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&w=1200&q=75'
...
export const MOCK_HOTELS = [
  ...
  },
  {
    ...
    images: [
      'https://images.unsplash.com/photo-1501785888041-af3ef285b470?auto=format&fit=crop&w=1200&q=75',
      'https://images.unsplash.com/photo-1544644181-1484b3fdfc62?auto=format&fit=crop&w=1200&q=75',
      'https://images.unsplash.com/photo-1527004013197-933c4bb611b3?auto=format&fit=crop&w=1200&q=75',
    ],
  ...
  },
  {
    ...
    images: [
      'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&w=1200&q=75',
      'https://images.unsplash.com/photo-1582719508461-905c673771fd?auto=format&fit=crop&w=1200&q=75',
      'https://images.unsplash.com/photo-1563911546344-647715ed5d76?auto=format&fit=crop&w=1200&q=75',
    ],
...
export const MOCK_CARS = [
  {
    ...
    currency: Currency.THB,
    images: ['https://images.unsplash.com/photo-1584345604476-8ec5e12e42dd?auto=format&fit=crop&w=1200&q=75'],
  ...
  },
  {
    ...
    currency: Currency.THB,
    images: ['https://images.unsplash.com/photo-1519641471654-76ce0107ad1b?auto=format&fit=crop&w=1200&q=75'],
  ...
  {
    id: 'mock-car-3',
    name_th: 'โตโยต้า ราฟ4 ไฮบริด',
    name_en: 'Toyota RAV4 Hybrid',
    description_th: 'SUV ขับเคลื่อนสี่ล้อ ประหยัดน้ำมัน เหมาะกับทริปขึ้นดอยและถนนลูกรัง ห้องโดยสารกว้าง เก็บสัมภาระได้เยอะ',
    description_en: 'All-wheel-drive hybrid SUV, fuel efficient and built for mountain roads and gravel tracks. Roomy cabin with generous luggage space.',
    car_type_th: 'SUV',
    car_type_en: 'SUV',
    max_passengers: 5,
    price_per_day: 3200,
    base_price_per_day: 3200,
    currency: Currency.THB,
    images: ['https://images.unsplash.com/photo-1617469767053-d3b523a0b982?auto=format&fit=crop&w=1200&q=75'],
    includes_th: ['ประกันชั้นหนึ่ง', 'ที่ยึดจักรยาน', 'น้ำมันเต็มถัง', 'GPS'],
    includes_en: ['First Class Insurance', 'Bike Rack', 'Full Tank', 'GPS'],
    is_active: true,
    created_at: new Date().toISOString(),
  },
  {
    id: 'mock-car-4',
    name_th: 'เทสลา โมเดล วาย',
    name_en: 'Tesla Model Y',
    description_th: 'รถไฟฟ้าล้วน ออกตัวเงียบ ไม่มีค่าน้ำมัน ชาร์จฟรีที่จุดชาร์จพันธมิตรทั่วเชียงราย พร้อมระบบช่วยขับอัตโนมัติ',
    description_en: 'Fully electric with instant, silent acceleration and no fuel cost. Free charging at partner points across Chiang Rai, with autopilot assistance.',
    car_type_th: 'รถยนต์ไฟฟ้า',
    car_type_en: 'Electric',
    max_passengers: 5,
    price_per_day: 4200,
    base_price_per_day: 4200,
    currency: Currency.THB,
    images: ['https://images.unsplash.com/photo-1600661653561-629509216228?auto=format&fit=crop&w=1200&q=75'],
    includes_th: ['ชาร์จฟรี', 'ประกันชั้นหนึ่ง', 'Autopilot', 'สายชาร์จพกพา'],
    includes_en: ['Free Charging', 'First Class Insurance', 'Autopilot', 'Portable Charger'],
    is_active: true,
    created_at: new Date().toISOString(),
  },
  {
    id: 'mock-car-5',
    name_th: 'เฟียต 500 ซิตี้',
    name_en: 'Fiat 500 City',
    description_th: 'รถเล็กคล่องตัว จอดง่ายในเมืองเก่า ประหยัดน้ำมันที่สุดในรุ่น เหมาะกับคู่รักหรือเดินทางคนเดียว',
    description_en: 'A compact, nimble city car that parks anywhere in the old town. The most fuel efficient in the fleet — ideal for couples or solo trips.',
    car_type_th: 'รถเล็กในเมือง',
    car_type_en: 'City Car',
    max_passengers: 4,
    price_per_day: 1200,
    base_price_per_day: 1200,
    currency: Currency.THB,
    images: ['https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&w=1200&q=75'],
    includes_th: ['ประกันชั้นหนึ่ง', 'ประหยัดน้ำมัน', 'Bluetooth', 'จอดง่าย'],
    includes_en: ['First Class Insurance', 'Fuel Saver', 'Bluetooth', 'Easy Parking'],
    is_active: true,
    created_at: new Date().toISOString(),
  },
  {
    id: 'mock-car-6',
    name_th: 'เมอร์เซเดส-เอเอ็มจี จีที',
    name_en: 'Mercedes-AMG GT',
    description_th: 'สปอร์ตคูเป้สมรรถนะสูง สำหรับโอกาสพิเศษ งานแต่ง หรือถ่ายพรีเวดดิ้ง มีคนขับให้เลือกเพิ่มได้',
    description_en: 'A high-performance sports coupe for special occasions, weddings and pre-wedding shoots. Optional chauffeur available.',
    car_type_th: 'รถสปอร์ตหรู',
    car_type_en: 'Luxury Sports',
    max_passengers: 2,
    price_per_day: 15000,
    base_price_per_day: 15000,
    currency: Currency.THB,
    images: ['https://images.unsplash.com/photo-1605559424843-9e4c228bf1c2?auto=format&fit=crop&w=1200&q=75'],
    includes_th: ['ประกันชั้นหนึ่ง', 'คนขับ (เสริม)', 'ตกแต่งงานแต่ง', 'น้ำมันเต็มถัง'],
    includes_en: ['First Class Insurance', 'Chauffeur (optional)', 'Wedding Decor', 'Full Tank'],
    is_active: true,
    created_at: new Date().toISOString(),
  },
]
