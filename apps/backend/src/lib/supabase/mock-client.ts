...
const tables: Record<string, Row[]> = {
  ...
  processed_webhooks: [],
  login_attempts: [],
  admin_notifications: [...MOCK_ADMIN_NOTIFICATIONS],
  availability_blocks: [],
  admin_audit_log: [...MOCK_ADMIN_AUDIT_LOG],
  email_campaigns: [],
  email_unsubscribes: [],
  user_wishlist: [...MOCK_WISHLIST],
  referrals: [...MOCK_REFERRALS],
  loyalty_ledger: [...MOCK_LOYALTY_LEDGER],
}
